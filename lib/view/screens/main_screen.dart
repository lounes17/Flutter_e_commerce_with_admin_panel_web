            ...
            bottomNavigationBar: BottomNavigationBar(
              ...
              [
                ...
                BottomNavigationBarItem(
                    ...
                    label: "",
                    activeIcon: Icon(Icons.category, color: mainColor,)
                ),
                BottomNavigationBarItem(
                ...
                BottomNavigationBarItem(
                    icon: Icon(Icons.settings, color: Get.isDarkMode ? Colors.white : Colors.black,),
                    label: "",
                    activeIcon: Icon(Icons.settings, color : mainColor,)
                ),
